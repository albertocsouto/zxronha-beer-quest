				...
				case "IF":
					Select Case listaPalabras (1)
						...
						Case "OBJECT_COUNT"
							...
							numClausulas = numClausulas + 1
						Case "KEY_COUNT"
							clausula = clausula + chr (&H42) + chr (pval (listaPalabras (3)))
							clausulasUsed (&H42) = -1
							numClausulas = numClausulas + 1
						Case "NPANT"
...
If clausulasUsed (&H42) Then
	print #f, "                case 0x42:"
	print #f, "                     // IF KEY_COUNT = n"
	print #f, "                     // Opcode: 42 n"
	print #f, "                     n = read_vbyte ();"
	print #f, "                     terminado = (player.keys != n);"
	print #f, "                     break;"
End If
...
if actionsUsed (&H42) Then
	print #f, "                    case 0x42:"
	print #f, "                        // DEC OBJECTS n"
	print #f, "                        // Opcode: 42 n"
	print #f, "                        n = read_vbyte ();"
	print #f, "                        player.keys -= n;"
	print #f, "                        draw_objs ();"
	print #f, "                        break;"
End If
